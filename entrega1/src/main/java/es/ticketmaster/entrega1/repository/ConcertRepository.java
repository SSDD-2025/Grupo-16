...
/**
 * Repository of Concerts containing methods declaration used for querys in the
 * DataBase
 */
public interface ConcertRepository extends JpaRepository<Concert, Long> {
     ...
     *
     * @param place is the country/ city which the search is based
     * @return the page of the concerts taking place at the country/ city
     * specified
     */
    ...
    /**
     * Returns the page of the earliest concerts to display on the main page (when anon
     * user is navigating the web)
     *
     * @return a page containing said concerts
     */
    public Page<Concert> findByOrderByDateAsc(Pageable pageable);

    /**
     * Searches the concerts which name matches (contains) the introduced
     * parameter
     *
    ...
    /**
     * Searches the concerts which artist name exactly matches the introduced
     * parameter
     *
    ...
    /**
     * Searches the concerts which artist name matches (contains) the introduced
     * parameter
     *
     * @param search searching parameter
     * @return List of Concerts that match
    ...
    /**
     * This query will return the number of rows udpated. In this case, the
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on controlling the number of available
     * tickets for the westStands section. By doing this, the concurrent access
     * to the the tickets that the different users can purchase is controlled.
     *
     ...
     * @return the number of rows that will be updated. In this case, should be
     * 1 or 0 as I mentioned previosly.
     */
    @Transactional
    @Modifying
     ...
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on controlling the number of available
     * tickets for the eastStands section. By doing this, the concurrent access
     * to the the tickets that the different users can purchase is controlled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     ...
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on controlling the number of available
     * tickets for the northStands section. By doing this, the concurrent access
     * to the the tickets that the different users can purchase is controlled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     ...
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on controlling the number of available
     * tickets for the generalAdmission section. By doing this, the concurrent
     * access to the the tickets that the different users can purchase is
     * controlled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     ...
     * This query will return the number of rows udpated. In this case, the
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on updating the number of the westStands
     * tickets available if the user cancel de purchase. In other words, this
     * query will be in charge of restoring the number of westStands tickets
     * selected by the user, when the purchase has been canceled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     * @param number is the ammount of tickets that the user has selected.
     * @return the number of rows that will be updated. In this case, should be
     * 1 or 0 ass I mentioned previously.
     */
    @Transactional
    @Modifying
     ...
     * This query will return the number of rows udpated. In this case, the
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on updating the number of the eastStands
     * tickets available if the user cancel de purchase. In other words, this
     * query will be in charge of restoring the number of eastStands tickets
     * selected by the user, when the purchase has been canceled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     ...
     * This query will return the number of rows udpated. In this case, the
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on updating the number of the northStands
     * tickets available if the user cancel de purchase. In other words, this
     * query will be in charge of restoring the number of northStands tickets
     * selected by the user, when the purchase has been canceled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
     ...
     * This query will return the number of rows udpated. In this case, the
     * possible values will be 1 or 0, since only 1 row can be updated. In
     * specific, this query is focus on updating the number of the
     * generalAdmission tickets available if the user cancel de purchase. In
     * other words, this query will be in charge of restoring the number of
     * generalAdmission tickets selected by the user, when the purchase has been
     * canceled.
     *
     * @author Alfonso Rodríguez Gutt and Arminda García Moreno.
     * @param id is the identification number for the concert.
